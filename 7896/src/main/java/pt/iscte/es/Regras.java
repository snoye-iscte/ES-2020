...
public class Regras implements RegraInterface {
	public DefectEnum defectEnum;
	MetricEnum metric1;
	...
	public Regras(DefectEnum defectEnum, MetricEnum metric1, int threshold1, MetricEnum metric2, int threshold2) {
