	...
	public void button_function() {
		...
		runButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Defect defect = defectString == "Long Method" ? Defect.isLongMethod : Defect.featureEnvy;
				Metric metric1;
				if(metric1String == "LOC") {
					metric1 = Metric.LOC;
				} else if(metric1String == "CYCLO") {
					metric1 = Metric.CYCLO;
				...
				Operation operation = operationString == "∧" ? Operation.AND : Operation.OR;
				Metric metric2;
